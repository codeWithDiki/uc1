                        ...
                        <tbody>
                        	@foreach($beli as $key => $value)
	                        	...
	                        	<tr>
	                        		...
	                        		<button wire:click="followUp('proses',{{$value['id']}})" class="bg-green-500 hoverL:bg-green-700 text-white font-bold py-1 px-1 pr-1 pl-1 rounded">
	                        			Proses
	                        		</button>
	                        		@elseif($value['status'] == "diproses")
	                        		<button wire:click="followUp('selesaikan',{{$value['id']}})" class="bg-green-500 hoverL:bg-green-700 text-white font-bold py-1 px-1 pr-1 pl-1 rounded">
	                        			Selesaikan
	                        		</button>
	                        		@else
	                        			Transaksi Selesai
